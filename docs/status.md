...
Reviewed against the code and project board on **2026-09-14**. This is the public
...
| Provider context normalization | Versioned source bundle, session-scoped request/agent joins, explicit loss states, frozen-rate pricing provenance, and optional attempt persistence | [Evidence normalization](../src/benchmark/context-evidence.ts)                                                                     |
