...
| Automation and extensibility            | Library, custom providers/hooks, MCP, CI gates and exports                                               | Scriptable CLI and local read API; pipeline JSON output carries the record alone                            | Shared bounded queries/read-only MCP and aggregate export accepted; CI is a proposal                                        |
